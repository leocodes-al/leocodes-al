...
🚀 Focado na criação de aplicações web modernas, funcionais e inspiradas em projetos reais  
...
Venho desenvolvendo projetos práticos para aprimorar minhas habilidades em front-end, organização de interfaces, componentização, responsividade e experiência do usuário, enquanto continuo evoluindo meus conhecimentos para atuar também no back-end futuramente.  
...
🛒 **Hortifruti Web**  
Sistema web com carrinho de compras e finalização de pedidos via WhatsApp, focado em lógica JavaScript, manipulação de DOM e experiência do usuário.  

🚧 Novos projetos e funcionalidades sendo desenvolvidos continuamente.
